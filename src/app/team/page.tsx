...
const milestones = [
  {
    ...
    title: "Team Founded",
    description:
      "Zero Strikes was born with a vision to dominate Free Fire esports.",
  },
  {
    year: "2023",
    title: "First Major Win",
    description: "Captured our first regional championship title.",
  },
  {
    year: "2024",
    title: "International Debut",
    description: "Represented our region in the World Championship.",
  },
  {
    year: "2025",
    title: "Expansion",
    description:
      "Built a state-of-the-art gaming house and expanded our roster.",
  },
];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground font-heading max-w-2xl">
              Zero Strikes is not just a team—it's a movement. We represent the
              pinnacle of Free Fire competitive gaming, built on skill, strategy,
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground">
              What started as a group of passionate gamers has evolved into one of
              the most feared teams in Free Fire esports.
            </p>
          </motion.div>
            ...
            {[
              {
                title: "Excellence",
                description:
                  "We strive for perfection in every match.",
              },
              {
                title: "Unity",
                description:
                  "Our strength lies in our bond.",
              },
              {
                title: "Innovation",
                description:
                  "We constantly evolve our strategies.",
              },
            ].map((value, index) => (
              <motion.div
                key={value.title}
