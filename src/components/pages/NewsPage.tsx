...
const news = [
  {
    ...
    excerpt: "Our team secured a commanding victory in the Southeast Asia Regional Finals, showcasing exceptional teamwork and individual skill that left opponents in awe.",
  ...
  },
  {
    ...
    excerpt: "We are excited to announce the addition of STORM to our roster as our new dedicated sniper, bringing unparalleled precision to the team.",
  ...
  },
  {
    ...
    excerpt: "Get an exclusive look at how Zero Strikes prepares for major tournaments with our intense training schedule and strategy sessions.",
  ...
  },
  {
    ...
    excerpt: "Zero Strikes partners with GameTech for exclusive gaming peripherals and equipment sponsorship.",
  ...
  },
  {
    ...
    excerpt: "Team captain PHOENIX receives the Most Valuable Player award for outstanding performance throughout the tournament.",
  ...
  },
  {
    ...
    excerpt: "Take a virtual tour of our newly renovated gaming house featuring state-of-the-art equipment and training facilities.",
      ...
      {featuredArticle && (
        <section className="py-12 bg-background-secondary">
          <div className="container mx-auto px-4">
            ...
            >
              <Link to={`/news/${featuredArticle.id}`} className="flex flex-col lg:flex-row">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredNews.filter(a => !a.featured).map((article, index) => (
              <motion.article
                key={article.id}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
