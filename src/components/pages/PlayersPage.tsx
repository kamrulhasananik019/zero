                ...
                <div className="w-full lg:w-1/3">
                  <div className="relative glass-card gaming-border overflow-hidden group">
                    ...
                    <div className="absolute bottom-4 left-4 flex gap-2">
                      <a href={player.social.twitter} className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-primary/20 transition-colors">
                        <Twitter size={18} />
                      </a>
                      <a href={player.social.youtube} className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-primary/20 transition-colors">
                        <Youtube size={18} />
                      </a>
                      <a href={player.social.twitch} className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center hover:bg-primary/20 transition-colors">
                        <Twitch size={18} />
                      </a>
                    </div>
                  </div>
