...
const sponsors = [
  {
    ...
    name: "GameTech",
    tier: "Title Sponsor",
    description: "Leading gaming hardware manufacturer providing our team with cutting-edge equipment.",
  ...
  },
  {
    ...
    description: "Premium gaming peripherals brand known for precision and reliability.",
  ...
  },
  {
    ...
    name: "EnergyDrink",
    tier: "Premium Partner",
    description: "The fuel that keeps our players performing at their best during intense matches.",
  ...
  },
  {
    ...
    description: "Professional streaming solutions for content creators and esports teams.",
  ...
  },
  {
    ...
    name: "CloudHost",
    tier: "Official Partner",
    description: "Reliable cloud hosting services powering our digital infrastructure.",
    logo: "https://images.unsplash.com/photo-1614680376573-df3480f0c6ff?w=400&h=200&fit=crop",
    website: "#",
  },
  {
    ...
    name: "GamerSnacks",
    tier: "Official Partner",
    description: "Healthy snacks designed for gamers, keeping our players energized.",
    logo: "https://images.unsplash.com/photo-1614680376408-81e91ffe3db7?w=400&h=200&fit=crop",
    website: "#",
  },
];
  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground font-heading">
              We're grateful for the amazing partners who support Zero Strikes on our journey to the top.
            </p>
          </motion.div>
        </div>
      </section>
      ...
      {tiers.map((tier, tierIndex) => {
        ...
        return (
          <section key={tier.name} className={`py-16 ${tierIndex % 2 === 1 ? "bg-background-secondary" : ""}`}>
            <div className="container mx-auto px-4">
              <motion.div
                ...
                className="mb-12"
              >
                <h2 className={`text-3xl font-display font-bold ${tier.color}`}>
                  {tier.name}
                </h2>
              ...
              <div className={`grid gap-8 ${
                ...
                {tierSponsors.map((sponsor, index) => (
                  ...
                  >
                    <div className={`relative ${tier.name === "Title Sponsor" ? "h-48" : "h-40"} bg-muted flex items-center justify-center overflow-hidden`}>
                      <img
                        src={sponsor.logo}
                        alt={sponsor.name}
                    ...
                    <div className="p-6">
                      <div className="flex items-start justify-between gap-4">
                        <div>
                          ...
                          <p className={`text-sm font-heading uppercase tracking-wider ${tier.color} mt-1`}>
                            {sponsor.tier}
                          </p>
                        </div>
                        <a 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Interested in partnering with Zero Strikes? We're always looking for brands that share 
              our passion for gaming and excellence. Let's create something amazing together.
            </p>
            <Link to="/contact">
